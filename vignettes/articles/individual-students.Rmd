...
*course.* &nbsp; For this student, the records show `r nrow(course[mcid == id_we_want & term_course <= first_degree_term])` courses (one row per course) leading up to their first degree.
