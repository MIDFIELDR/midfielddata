...
#'   \item{CIP6}{Six-digit CIP code of the program into which the student matriculated.}
#'   \item{term_enter}{Academic year and term the student first entered the institution.}
#'   \item{transfer}{Did the student transfer into the institution? (Y = Yes or N = No).}
...
#'   \item{race}{Ethnicity as self-reported by the student and as reported to IPEDS.}
...
#'   \item{high_school}{High school code for the last high school attended before entering a post-secondary institution}
#'   \item{SAT_math}{SAT mathematics test score, used as part of the admissions process.}
#'   \item{SAT_verbal}{SAT reading test score, used as part of the admissions process.}
#'   \item{ACT_comp}{ACT composite test score, used as part of the admissions process.}
#' }
#'
