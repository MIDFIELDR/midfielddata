...
- Ensure values of “” are replaced with NA_character\_

## version 0.1.4

2022-07

- Match variable names in practice data to those in MIDFIELD research
  data
...
- Added data tests to check for range and possible values

## version 0.1.2

2021-06

- changed names of data tables and variables to be consistent with
  research data
- remove Travis CI
