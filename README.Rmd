...
<br>An `R` data package containing anonymized student-level records for 98,000 undergraduates, a sample of the MIDFIELD database to practice using the tools and methods provided by the `midfieldr` package.
