...
<br>An 'R' data package that provides undergraduate student-level data sampled from the MIDFIELD database.
...
'midfielddata' is licensed under CC0 1.0 [(CC0 summary)](https://creativecommons.org/publicdomain/zero/1.0/legalcode) [(CC0 full license)](LICENSE.html).
